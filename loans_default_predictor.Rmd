...
ggplot(loansgeo)+
  geom_bar(aes(x = emp_length))+ scale_fill_brewer(palette = "Dark2")+
  coord_flip()+
...
labs( x= "Loan Amount",
        ...
        title = "Lending Club Default Loans Data")
```
#### Here you can see four spikes in the data where there are more defaults on certain values of loans - $7,000, $18,000, $25,000 and then the max of $35,000 - these loan size could be considered a factor in the probabilty of a customer defaulting and risk profile increased (e.g interest rates) increased at these particular values.
...
#### But we need to think carefully about the statistical significance of each predictor. A good first step in this direction is to examine the p-value of each predictor.
...
#### From this we can see that dti and loan amount continue to be strong strong but annual income not.  
